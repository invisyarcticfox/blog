...
date: '6 July 2026 09:25'
---
import { Image} from 'astro:assets'
import Emote from '~/components/Emote.astro'
import arealpain from '~/assets/emotes/arealpain.jpg'
import balconyfall from './img/balconyfall.png'
import bridgeescape from './img/bridgeescape.png'
import formats from './img/formats.png'
import blender1 from './img/blender1.png'
import blender2 from './img/blender2.png'
import blender3 from './img/blender3.png'
import blender4 from './img/blender4.png'
import blender5 from './img/blender5.png'
import blenderlorry from './img/blenderlorry.png'
import endcopy from './img/endcopy.png'
import endlorry from './img/endlorry.png'
import endlorrybones from './img/endlorrybones.png'
import endlorrybonestrailer from './img/endlorrybonestrailer.png'
import endlorrybonestrailer2 from './img/endlorrybonestrailer.gif'
import endlorryxml from './img/endlorryxml.png'
import endlorrycabbone from './img/endlorrycabbone.gif'
import endlorrycabbone2 from './img/endlorrycabbone2.gif'
import endlorrygraph from './img/endlorrygraph.png'
import endcharfiles from './img/endcharfiles.png'
import endcharexp from './img/endcharexp.png'
import endcharexp2 from './img/endcharexp2.png'
import fbxexport from './img/fbxexport.png'
...
<Image src={formats} alt={'formats'} style={{ '--w': '50%' }} />
...
This is an absolutely *horrible* rest pose. The spine is completely horizontal meanwhile the arms face back and legs face down, and they're even strangely crossed.
...
<Image src={endcopy} alt={'endorphin copyright'} style={{ '--w': '50%' }} />
...
<Image src={fbxexport} alt={'fbxexport'} style={{ '--w': '50%' }} />
...
{/* <Image src={endcharfiles} alt={'endcharfiles'} style={{ '--w': '75%' }} /> */}
...
Endorphin does have "Graphical Objects" which are essentially just a mesh parented to the collision objects to save on simulating every face, but I honestly didn't try to import those as I honestly am not interested, the collision objects are more than enough.
