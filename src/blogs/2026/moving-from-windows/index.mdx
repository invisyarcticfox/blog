...
date: '14 January 2026 11:50'
---
import { Image } from 'astro:assets'
import aiopt from './img/ai.png'
import updateshutdown from './img/updateshutdown.png'
import backup from './img/backup.png'
...
<div class='list'>
  1. The dumb AI shit
      ...
      <Image src={aiopt} alt={'ai options'} style={{ '--w':'50%' }} loading={'eager'} />
  ...
  2. The constant updates
      ...
      <Image src={updateshutdown} alt={'update shutdown'} style={{ '--w':'50%' }} />
  ...
  3. The constant reminders to backup my PC
      ...
      <Image src={backup} alt={'backup'} style={{ '--w':'75%' }} />
