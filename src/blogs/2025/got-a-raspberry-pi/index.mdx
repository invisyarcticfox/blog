...
date: '11 November 2025 16:57'
---
import { Image } from 'astro:assets'
import Emote from '~/components/Emote.astro'
import taskbar from './img/taskbar.png'
import pi from './img/thepi.jpg'
import shug from '~/assets/emotes/shug.png'

So, I finally decided to get a Raspberry Pi.
...
<Image src={taskbar} alt={'taskbar'} width={512} style={{ '--w': '50%' }} loading={'eager'} />
...
<Image src={pi} alt={'pi'} style={{ '--w': '50%' }} width={720} />
