...
date: '18 April 2025 14:24'
---
import { Image } from 'astro:assets'
import sp3d from './img/substancepainter.png'
import currtex from './img/currtex.png'
...
<Image src={currtex} alt={'currtex'} loading={'eager'} width={1080} style={{ '--w': '75%' }} />
...
<div class='grid'>
  <Image src={arm} alt={'arm'} width={512}  />
  <Image src={neck} alt={'neck'} width={512}  />
</div>
