...
date: '3 July 2025 13:03'
---
import { Image } from 'astro:assets'
import links from './img/links.png'
import icons from './img/icons.png'
import sonaart from './img/sonaart.png'

As of recent, I've been struggling with designing an index page for my main index.
...
<Image src={links} alt={'links'} width={720} loading={'eager'} style={{ '--w': '75%' }} />
...
<Image src={icons} alt={'icons'} width={720} loading={'eager'} style={{ '--w': '75%' }} />
...
<Image src={sonaart} alt={'sonaart'} loading={'eager'} width={720} style={{ '--w': '50%' }} />
