...
date: '11 June 2025 07:03'
---
import { Image } from 'astro:assets'
import older from './img/old.png'
import newer from './img/new.png'
import bite from './img/bite.png'
import irlhair from './img/irlhair.png'
...
<div class='grid'>
  <Image src={older} alt={'old'} width={720} loading={'eager'} />
  <Image src={newer} alt={'new'} width={720} loading={'eager'} />
</div>
...
<Image src={irlhair} alt={'irlhair'} width={1080} quality={'max'} />
