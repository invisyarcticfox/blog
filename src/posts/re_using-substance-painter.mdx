...
Although, I haven't been working on it for those two months. I restarted my progress a couple nights ago and actually finished it within a couple days. I guess I just didn't have the motivation to continue it since [the last post](./using-substance-painter).
