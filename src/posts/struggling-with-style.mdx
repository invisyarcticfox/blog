...
<Image src={links} alt={'links'} width={720} loading={'eager'} />
...
<Image src={icons} alt={'icons'} width={720} loading={'eager'} />
...
<Image src={sonaart} alt={'sonaart'} loading={'eager'} height={1080} />
