...
<Image src={fzfront} alt={'fzfront'} loading={'eager'} width={720} />
...
but those weird lines under the chair's arm and inside the mic's pop filter is what I'm talking about.
