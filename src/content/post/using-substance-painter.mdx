...
import sp3d from '@/assets/substance/substancepainter.png'
import currtex from '@/assets/substance/currtex.png'
import arm from '@/assets/substance/arm.png'
import neck from '@/assets/substance/neck.png'


## Starting to learn Substance Painter 3D
...
<Image
  src={currtex} alt={'currtex'}
  loading={'eager'} title={'current texture'}
  style={{width: `100%`}} width={720}
/>
...
<Image src={arm} alt={'arm'} loading={'lazy'} title={'left arm'} />
<Image src={neck} alt={'neck'} loading={'lazy'} title={'underside of neck'} />
